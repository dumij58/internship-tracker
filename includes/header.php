    ...
    <div class="navbar">
        <div class="nav-container">
            ...
            <?php elseif (isset($_SESSION['role']) && $_SESSION['role'] === 'company'): ?>
                ...
                <!-- Company Navigation -->
                <a href="<?php echo $pages_path; ?>/company/index.php" class="nav-brand">Application Tracker</a>
                <div class="nav-links">
            ...
            <?php endif; ?>
                ...
                <a href="<?php echo $pages_path; ?>/auth/logout.php" class="nav-logout">Logout</a>
            </div>
        </div>
    </div>
